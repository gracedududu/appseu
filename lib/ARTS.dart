...
class _QuestreviewState extends State<Questreview> {
  ...
  Widget build(BuildContext context) {
    String mainText = '';
    if (widget.index == 0) {
      mainText = '\n${widget.index + 1}. Who painted the Mona Lisa?\n\n'
          'A.         Michelangelo\n'
          'B. Leonardo da Vinci\n'
          'C.        Pablo Picasso\n'
          'D.   Vincent van Gogh\n';
    } else if (widget.index == 1) {
      mainText = '\n${widget.index + 1}. Who wrote "Romeo and Juliet"?\n\n'
          'A. William Shakespeare\n'
          'B.                Jane Austen\n'
          'C.                  Mark Twain\n'
          'D.          Charles Dickens\n';
    } else if (widget.index == 2) {
      mainText = '\n${widget.index + 1}. Who composed the opera "The Magic Flute"?\n\n'
          'A. Wolfgang Amadeus Mozart\n'
          'B.          Ludwig van Beethoven\n'
          'C.        Johann Sebastian Bach\n'
          'D.                       Franz Schubert\n';
    } else if (widget.index == 3) {
      mainText = '\n${widget.index + 1}. What is the nationality of the painter Frida Kahlo?\n\n'
          'A.  Spanish\n'
          'B.    French\n'
          'C. Mexican\n'
          'D.     Italian\n';
    } else if (widget.index == 4) {
      mainText = '\n${widget.index + 1}. Who wrote the novel "To Kill a Mockingbird"?\n\n'
          'A.              Harper Lee\n'
          'B.  F. Scott Fitzgerald\n'
          'C. Ernest Hemingway\n'
          'D.            J.D. Salinger\n';
    } else if (widget.index == 5) {
      mainText = '\n${widget.index + 1}. Who composed the "Four Seasons"?\n\n'
          'A.   Ludwig van Beethoven\n'
          'B. Johann Sebastian Bach\n'
          'C.                Antonio Vivaldi\n'
          'D.           Johannes Brahms\n';
    } else if (widget.index == 6) {
      mainText = '\n ${widget.index + 1}. Who painted "The Starry Night"?\n\n'
          'A.       Pablo Picasso\n'
          'B.        Claude Monet\n'
          'C.  Vincent van Gogh\n'
          'D.          Salvador Dalí\n';
    } else if (widget.index == 7) {
      mainText = '\n${widget.index + 1}. Who wrote "The Canterbury Tales"?\n\n'
          'A. William Wordsworth\n'
          'B.      Geoffrey Chaucer\n'
          'C.                John Milton\n'
          'D. William Shakespeare\n';
    } else if (widget.index == 8) {
      mainText = '\n\n${widget.index + 1}. Who composed the opera "Carmen"?\n\n'
          'A.Wolfgang Amadeus Mozart\n'
          'B.                      Giuseppe Verdi\n'
          'C.         Ludwig van Beethoven\n'
          'D.                        Georges Bizet\n';
    } else if (widget.index == 9) {
      mainText = '\n${widget.index + 1}. Who painted the ceiling of the Sistine Chapel?\n\n'
          'A.  Leonardo da Vinci\n'
          'B.          Michelangelo\n'
          'C.                   Raphael\n'
          'D.                 Botticelli\n';
          } else if (widget.index == 10) {
      mainText = '\n${widget.index + 1}. Who wrote "1984"?\n\n'
          'A. Aldous Huxley\n'
          'B.  George Orwell\n'
          'C.         H.G. Wells\n'
          'D.      Jules Verne\n';
          } else if (widget.index == 11) {
      mainText = '\n${widget.index + 1}. Who composed the opera "The Marriage of Figaro"?\n\n'
          'A.                  Giacomo Puccini\n'
          'B.                    Richard Wagner\n'
          'C.         Ludwig van Beethoven\n'
          'D. Wolfgang Amadeus Mozart\n';
          } else if (widget.index == 12) {
      mainText = '\n${widget.index + 1}. Who wrote "Pride and Prejudice"?\n\n'
          'A.        Emily Brontë\n'
          'B.        Jane Austen\n'
          'C.  Charlotte Brontë\n'
          'D.      Virginia Woolf\n';
          } else if (widget.index == 13) {
      mainText = '\n${widget.index + 1}. Who composed the "Moonlight Sonata"?\n\n'
          'A.  Wolfgang Amadeus Mozart\n'
          'B.          Ludwig van Beethoven\n'
          'C.        Johann Sebastian Bach\n'
          'D.                       Franz Schubert\n';
          } else if (widget.index == 14) {
                  mainText = '\n${widget.index + 1}. Who painted "Guernica"?\n\n'
          'A.       Pablo Picasso\n'
          'B. Vincent van Gogh\n'
          'C.       Claude Monet\n'
          'D.        Salvador Dalí\n';
