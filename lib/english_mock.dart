...
class _QuestreviewState extends State<Questreview> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.index == 0) {
      ...
      mainText = '\n${widget.index + 1}.You can use my car ______ tomorrow.\n\n'
          'A.          Yet\n'
          'B.      Since\n'
          'C.        Until\n'
          'D.   Around\n';
    } else if (widget.index == 4) {
      mainText = '\n${widget.index + 1}. Choose the word that means "to persuade someone to do something through flattery or coaxing".\n\n'
          'A.     Encourage\n'
          'B.             Cajole\n'
          'C.         Beseech\n'
          'D.           Implore\n';
    } else if (widget.index == 5) {
      mainText = '\n${widget.index + 1}. What is the meaning of the word "ameliorate".\n\n'
      ...
      mainText = '\n\n${widget.index + 1}. Which word is spelled correctly?\n\n'
          'A.      Meticuluous\n'
          'B.        Meticulous \n'
          'C.      Meticulouss\n'
          'D.        Meticuluss\n\n';
            ...
            Row(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Color.fromARGB(255, 220, 216, 216),// Change background color
                    textStyle: TextStyle(color: Color.fromARGB(255, 186, 146, 146)), // Change text color
                  ),
