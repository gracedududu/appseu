...
class _QuestreviewState extends State<Questreview> {
  ...
  String mainText = '';
  if (widget.index == 0) {
    mainText = '${widget.index + 1}. If all freshmen are required to take either Calculus or Statistics, and Maria is a freshman who is not taking Calculus, which of the following must be true?\n\n'
