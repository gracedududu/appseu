...
class _QuestreviewState extends State<Questreview> {
  ...
  String mainText = '';
  if (widget.index == 0) {
    mainText = '\n${widget.index + 1}. A farmer has 100 chickens and cows on his farm. If the total number of legs on the farm is 280, how many chickens does he have?\n'
        'A. 40\n'
        'B. 50\n'
        'C. 60\n'
        'D. 70\n';
  } else if (widget.index == 1) {
    mainText = '\n${widget.index + 1}. If 3x + 4y = 20 and x - 2y = 5, what is the value of x?\n\n'
        'A. 1\n'
        'B. 2\n'
        'C. 3\n'
        'D. 4\n';
  } else if (widget.index == 2) {
    mainText = '\n${widget.index + 1}. The ratio of the length to the width of a rectangle is 3:2. If the perimeter of the rectangle is 50 units, what is its area?\n'
        'A.   60 square units\n'
        'B.   75 square units\n'
        'C.   90 square units\n'
        'D. 100 square units\n';
  } else if (widget.index == 3) {
    mainText = '\n${widget.index + 1}. If a car travels at a speed of 60 kilometers per hour, how far will it travel in 2.5 hours?\n'
        'A. 120 kilometers\n'
        'B. 150 kilometers\n'
        'C. 160 kilometers\n'
        'D. 180 kilometers\n';
  } else if (widget.index == 4) {
    mainText = '\n${widget.index + 1}. What is the next number in the sequence: 1, 4, 9, 16, 25, ...?\n'
        'A. 30\n'
        'B. 36\n'
        'C. 40\n'
        'D. 49\n';
  } else if (widget.index == 5) {
    mainText = '\n${widget.index + 1}. If 2x + 3y = 15 and x + 2y = 10, what is the value of y?\n'
        'A. 1\n'
        'B. 2\n'
        'C. 3\n'
        'D. 4\n';
  } else if (widget.index == 6) {
    mainText = '\n${widget.index + 1}. A square and an equilateral triangle have the same perimeter. If the side length of the square is 6 units, what is the side length of the equilateral triangle?\n'
        'A.   4 units\n'
        'B.   6 units\n'
        'C.   8 units\n'
        'D. 10 units\n';
    ...
    mainText = '\n${widget.index + 1}. If a box contains 12 red balls, 8 blue balls, and 6 green balls, what is the probability of randomly selecting a blue ball from the box?\n'
        'A. 1/3\n'
        'B. 2/9\n'
        'C. 1/4\n'
        'D. 1/2\n';
  } else if (widget.index == 9) {
    mainText = '\n${widget.index + 1}. A ladder is leaning against a wall. The ladder reaches a height of 12 feet on the wall and forms a 45-degree angle with the ground. What is the length of the ladder?\n'
        'A. 12 feet\n'
        'B. 16 feet\n'
        'C. 18 feet\n'
        'D. 24 feet\n';
  } else if (widget.index == 10) {
    mainText = '\n${widget.index + 1}. The difference between two numbers is 12, and their sum is 36. What are the two numbers?\n'
        'A. 12 and 24\n'
        'B. 14 and 26\n'
        'C. 15 and 27\n'
        'D. 18 and 30\n';
  } else if (widget.index == 11) {
    mainText = '\n${widget.index + 1}. In a classroom, there are 30 students, and the ratio of boys to girls is 3:2. How many boys are there in the classroom?\n'
        'A. 12\n'
        'B. 15\n'
        'C. 18\n'
        'D. 20\n';
  } else if (widget.index == 12) {
    mainText = '\n${widget.index + 1}. A bakery sells cakes for P20 each. If the bakery sells 15 cakes in one day, how much money does it make from cake sales?\n'
        'A. P200\n'
        'B. P250\n'
        'C. P300\n'
        'D. P350\n';
  } else if (widget.index == 13) {
    mainText = '\n${widget.index + 1}. The area of a circle is 154 square centimeters. What is the circumference of the circle?\n'
        'A. 22 centimeters\n'
        'B. 28 centimeters\n'
        'C. 36 centimeters\n'
        'D. 44 centimeters\n';
  } else if (widget.index == 14) {
    mainText = '\n${widget.index + 1}. A company produces 500 units of a product per day. If the production rate increases by 20% each month, how many units will the company produce in three months?\n'
        'A. 3,600 units\n'
        'B. 3,840 units\n'
        'C. 4,000 units\n'
        'D. 4,160 units\n';
