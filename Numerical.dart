...
class _QuestreviewState extends State<Questreview> {
  ...
  Widget build(BuildContext context) {
    String mainText = '';
    if (widget.index == 0) {
        mainText = '${widget.index + 1}. Which share had the largest difference between highest and lowest price over the last 12 months? \n'
          ;

    } else if (widget.index == 1) {
      mainText = '${widget.index + 1}. Today’s Drebs Ltd share price represents a 40% increase on the price one month ago. What was the Drebs Ltd share price a month ago? \n'
          ;
    } else if (widget.index == 2) {
      mainText = '${widget.index + 1}. If a driver travels an average of 4,250 miles per month driving only along motorways in an Xtam car, what is the predicted annual consumption of fuel (in gallons)?\n'
          ;
    } else if (widget.index == 3) {
      mainText = '${widget.index + 1}. A car dealership has £600,000 to spend and wants to buy equal numbers of the Taber and Ursa cars. What is the largest number of each type of car that can be ordered?\n'
        ;
    } else if (widget.index == 4) {
      mainText = '${widget.index + 1}. Legal sector spending on IT hardware, IT software and IT consulting are all set to increase by the same amounts in Year 6 as they did from Year 4 to Year 5. Assuming this is the case, what would be the total legal sector spending in Year 6 on these three IT areas combined?\n'
         ;
    } else if (widget.index == 5) {
      mainText = '${widget.index + 1}. Which of the following statements is false regarding legal sector spending between Year 4 and projected Year 5?\n'
        ;
    } else if (widget.index == 6) {
      mainText = '${widget.index + 1}. IKE Computers aim to grow monthly gross profit by 1.5%. If all costs remain constant, what will the sales turnover need to be in February to hit the target?\n'
        ;
    } else if (widget.index == 7) {
      mainText = '${widget.index + 1}. If IKE Computers employed eighty permanent employees in January who were on the same salary, what would have been the effect on labour costs if they had replaced twenty permanent employees with interim staff each on monthly salaries of £3,000?\n'
         ;
    } else if (widget.index == 8) {
      mainText = '${widget.index + 1}. If the ratio of profit to turnover for Pacific Rim contracts was 2:15, what was the Government turnover in the Pacific Rim (in £100,000s)?\n'
        ;
    } else if (widget.index == 9) {
      mainText = '${widget.index + 1}. Reyes Heslop had a target for Leisure profits to be a quarter of their total profits. Assuming profits in other areas remain the same, by how much did the Leisure profits miss this target?\n'
        ;
    } 
    return Scaffold(
      appBar: AppBar(
              ...
              Padding(
                ...
                child: Center(
                  child: Container(
                    height: 400,
                    width: 450,
                    child: Image.asset('lib/n 12.png'),
                  ),
                ),
              ),
            ],
              ...
              Padding(
                ...
                child: Center(
                  child: Container(
                      height: 400,
                    width: 450,
                    child: Image.asset('lib/n 43.png'),
                  ),
                ),
              ),
            ],
              ...
              Padding(
                ...
                child: Center(
                  child: Container(
                    height: 400,
                    width: 450,
                    child: Image.asset('lib/n 65.png'),
                  ),
                ),
              ),
            ],
              ...
              Padding(
                ...
                child: Center(
                  child: Container(
                   height: 400,
                    width: 450,
                    child: Image.asset('lib/n 87.png'),
                  ),
                ),
              ),
            ],
              ...
              Padding(
                ...
                child: Center(
                  child: Container(
                   height: 400,
                    width: 450,
                    child: Image.asset('lib/n 910.png'),
                  ),
                ),
              ),
            ],
