...
class _QuestreviewState extends State<Questreview> {
 ...
 Widget build(BuildContext context) {
  String mainText = '';
  if (widget.index == 0) {
    mainText = '${widget.index + 1}. In a study on dietary habits, it was found that 60% of individuals who consume organic food also prefer homemade meals. If Maria prefers homemade meals, what type of food is she most likely to consume?\n\n'
        'A.           Fast food.\n'
        'B.       Frozen food.\n'
        'C. Processed food.\n'
        'D.      Canned food.\n';
  } else if (widget.index == 1) {
    mainText = '${widget.index + 1}. During a survey on smartphone usage, it was observed that 70% of individuals who own iPhones also own iPads. If Juan owns an iPad, which brand of smartphone is he most likely to own?\n\n'
        'A.      Samsung.\n'
        'B. Google Pixel.\n'
        'C.          Huawei.\n'
        'D.        OnePlus.\n';
  } else if (widget.index == 2) {
    mainText = '${widget.index + 1}. In a study on exercise routines, it was noted that 80% of individuals who practice Pilates also practice yoga. If Maria practices yoga, which form of exercise is she most likely to also practice?\n\n'
        'A. CrossFit.\n'
        'B.    Zumba.\n'
        'C.       Barre.\n'
        'D.     Tai Chi.\n';
  } else if (widget.index == 3) {
    mainText = '${widget.index + 1}. During a survey on travel preferences, it was found that 75% of individuals who prefer beach destinations also enjoy snorkeling. If Juan enjoys snorkeling, which type of travel destination is he most likely to prefer?\n\n'
        'A.  Mountain.\n'
        'B.       Desert.\n'
        'C.       Jungle.\n'
        'D.      Coastal.\n';
  } else if (widget.index == 4) {
    mainText = '${widget.index + 1}. In a study on pet ownership, it was observed that 65% of individuals who own cats also own indoor plants. If Maria owns indoor plants, what type of pet is she most likely to own?\n\n'
        'A.         Dog.\n'
        'B.         Fish.\n'
        'C.         Bird.\n'
        'D. Hamster.\n';
  } else if (widget.index == 5) {
    mainText = '${widget.index + 1}. During a survey on movie preferences, it was noted that 70% of individuals who enjoy action movies also enjoy thrillers. If Juan enjoys thrillers, which genre of movie is he most likely to also enjoy?\n\n'
        'A.    Comedy.\n'
        'B.       Drama.\n'
        'C.        Horror.\n'
        'D.   Romance.\n';
  } else if (widget.index == 6) {
    mainText = '${widget.index + 1}. In a study on transportation choices, it was found that 80% of individuals who use bicycles also use public transportation. If Maria uses public transportation, what mode of transportation is she most likely to also use?\n\n'
        'A.              Car.\n'
        'B. Motorcycle.\n'
        'C.       Scooter.\n'
        'D. Skateboard.\n';
  } else if (widget.index == 7) {
    mainText = '${widget.index + 1}. During a survey on coffee preferences, it was observed that 75% of individuals who drink espresso also enjoy cappuccino. If Juan enjoys cappuccino, which type of coffee is he most likely to also drink?\n\n'
        'A.          Latte.\n'
        'B. Americano.\n'
        'C.        Mocha.\n'
        'D. Macchiato.\n';
  } else if (widget.index == 8) {
    mainText = '${widget.index + 1}. In a study on reading habits, it was noted that 70% of individuals who read science fiction novels also read fantasy novels. If Maria reads fantasy novels, which genre of book is she most likely to also read?\n\n'
        'A.                 Mystery.\n'
        'B.              Romance.\n'
        'C. Historical Fiction.\n'
        'D.                   Thriller.\n';
  } else if (widget.index == 9) {
    mainText = '${widget.index + 1}. During a survey on leisure activities, it was found that 65% of individuals who enjoy hiking also enjoy camping. If Juan enjoys camping, which outdoor activity is he most likely to also enjoy?\n\n'
        'A.             Fishing.\n'
        'B.   Birdwatching.\n'
        'C. Rock Climbing.\n'
        'D.          Kayaking.\n';
  } else if (widget.index == 10) {
    mainText = '${widget.index + 1}. In a study on music preferences, it was observed that 70% of individuals who listen to classical music also listen to jazz. If Maria listens to jazz, which genre of music is she most likely to also listen to?\n\n'
        'A.        Pop.\n'
        'B.      Rock.\n'
        'C.     Blues.\n'
        'D. Hip Hop.\n';
  } else if (widget.index == 11) {
    mainText = '${widget.index + 1}. During a survey on fashion choices, it was noted that 75% of individuals who wear skirts also wear dresses. If Juan wears dresses, which type of clothing is he most likely to also wear?\n\n'
        'A.       Jeans.\n'
        'B.       Shorts.\n'
        'C.   Leggings.\n'
        'D.   Trousers.\n';
  } else if (widget.index == 12) {
    mainText = '${widget.index + 1}. In a study on cooking habits, it was found that 80% of individuals who bake cakes also bake cookies. If Maria bakes cookies, what type of dessert is she most likely to also bake?\n\n'
        'A.          Pies.\n'
        'B. Cupcakes.\n'
        'C.  Brownies.\n'
        'D.     Muffins.\n';
  } else if (widget.index == 13) {
    mainText = '${widget.index + 1}. During a survey on social media usage, it was observed that 70% of individuals who use Facebook also use Instagram. If Juan uses Instagram, which social media platform is he most likely to also use?\n\n'
        'A.     Twitter.\n'
        'B. Snapchat.\n'
        'C.      TikTok.\n'
        'D.   LinkedIn.\n';
  } else if (widget.index == 14) {
    mainText = '${widget.index + 1}. In a study on language learning, it was noted that 75% of individuals who speak Spanish also speak French. If Maria speaks French, which language is she most likely to also speak?\n\n'
        'A.       German.\n'
        'B.          Italian.\n'
        'C. Portuguese.\n'
        'D.    Mandarin.\n';
